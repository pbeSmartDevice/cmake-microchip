...
function(elf2hex target)
    find_program(MICROCHIP_BIN2HEX
        NAMES ${_CMAKE_TOOLCHAIN_PREFIX}objcopy objcopy
        HINTS ${_CMAKE_TOOLCHAIN_LOCATION}
    )

    if(NOT MICROCHIP_BIN2HEX)
        message(SEND_ERROR "No objcopy program was found")
    endif()
    ...
    add_custom_command(
        ...
        COMMAND "${MICROCHIP_BIN2HEX}" -O ihex ${in_f} ${out_f}
